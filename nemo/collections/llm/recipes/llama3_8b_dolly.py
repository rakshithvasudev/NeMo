...
def pretrain_recipe(
    ...
    recipe = run.Partial(
        ...
        data=run.Config(DollyDataModule, seq_length=8192, global_batch_size=512, micro_batch_size=1),
...
def finetune_recipe(
    ...
    recipe.data = run.Config(DollyDataModule, seq_length=seq_length, micro_batch_size=1, global_batch_size=512, force_redownload=False, delete_raw=False)
